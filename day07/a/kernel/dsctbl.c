...
void init_gdtidt(void)
{
	...
	/* IDT设置*/
	// set_gatedesc(idt + 0x06, (int) asm_inthandler06, 1 * 8, AR_INTGATE32);
	// set_gatedesc(idt + 0x08, (int) asm_inthandler08, 1 * 8, AR_INTGATE32);
	// set_gatedesc(idt + 0x0c, (int) asm_inthandler0c, 1 * 8, AR_INTGATE32);
